...
public sealed class RegisterCommandValidator : AbstractValidator<RegisterCommand>
{
    public RegisterCommandValidator()
    {
        ...
        RuleFor(p => p.Lastname).NotNull().WithMessage("Kullanıcı soyadı boş olamaz!");
        RuleFor(p => p.Lastname).MinimumLength(3).WithMessage("Kullanıcı soyadı en az 3 karakter olmalıdır!");
